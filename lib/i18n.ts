...
const en = {
  ...
  startAnotherWorkout: 'Start another workout',
  currentExercise: 'Current Exercise',
  workoutCompletedToday: 'WORKOUT COMPLETED',
  completedTodaySubtitle: 'Great job! You completed today’s workout.',
  thisWeek: 'THIS WEEK',
...
const uk: Record<TranslationKey, string> = {
  ...
  workoutInProgress: 'ТРЕНУВАННЯ ТРИВАЄ',
  viewSummary: 'ПЕРЕГЛЯНУТИ ПІДСУМОК',
  startAnotherWorkout: 'Почати інше тренування',
  currentExercise: 'Поточна вправа',
  workoutCompletedToday: 'ТРЕНУВАННЯ ЗАВЕРШЕНО',
  completedTodaySubtitle: 'Чудова робота! Сьогоднішнє тренування виконано.',
